...
**
** Copyri
**ght 2007, The Android Open Source Project
...
interface IPackageManager {
     ...
     * 
     * @return A List&lt;applicationUpdateInfo> containing one entry for each persistent
     ...
     * @param installerPackageName Optional package name of the applicationUpdateInfo that is performing the
     ...
     * @param packageName The package name of the applicationUpdateInfo whose cache
    ...
    /**
     * Clear the user data directory of an applicationUpdateInfo.
     * @param packageName The package name of the applicationUpdateInfo whose cache
     * files need to be deleted
   ...
   /**
     ...
     * @param packageName The package name of the applicationUpdateInfo
